            ...
            <div className="bg-secondary-100 p-8 rounded-xl shadow-lg shadow-primary w-auto lg:w-112.5">
                ...
                <div className="flex flex-col gap-4 items-center text-gray-100 mt-8">
                    <span className="flex gap-2 items-center">
                        ¿Ya tienes cuenta?<Link to="/login" className="text-primary hover:text-primary/80 transition-colors">Ingresa</Link>
                    </span>

                    <span className="flex gap-2 items-center">
                        ¿No tienes cuenta?<Link to="/registro" className="text-primary hover:text-primary/80 transition-colors">Registrate</Link>
                    </span>
                </div>
            </div>
        </div>
